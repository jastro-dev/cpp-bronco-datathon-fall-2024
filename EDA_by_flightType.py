...
for flightType in ['economic', 'premium', 'firstClass']:
    ...
    scatter = sns.scatterplot(data=df, x='distance', y='price',
                                ...
                                sizes=(20, 200))
    plt.title(f'[{flightType.title()}] Flight Prices vs Distance', pad=20, fontsize=12, fontweight='bold')
    ...
    plt.title(f'[{flightType.title()}] Price Ranges by Flight Type', pad=20, fontsize=12, fontweight='bold')
    ...
    bars = sns.barplot(data=route_counts, x='count', y='route',
                        palette='viridis')
    plt.title(f'[{flightType.title()}] Most Popular Flight Routes', pad=20, fontsize=12, fontweight='bold')
    ...
    violin = sns.violinplot(data=df, x='agency', y='price',
                            inner='box', cut=0)
    plt.title(f'[{flightType.title()}] Price Distribution by Agency', pad=20, fontsize=12, fontweight='bold')
    plt.xticks(rotation=30)
    ...
    temporal = sns.lineplot(data=df, x='date', y='price',
                            ci=None, linewidth=2)
    plt.title(f'[{flightType.title()}] Price Trends Over Time', pad=20, fontsize=12, fontweight='bold')
    plt.xticks(rotation=30)
    ...
    bars = sns.barplot(x=avg_price.index, y=avg_price.values,
                        palette='viridis')
    plt.title(f'[{flightType.title()}] Average Price by Agency', pad=20, fontsize=12, fontweight='bold')
    plt.xticks(rotation=30)
    plt.xlabel('Agency', fontsize=10)
    ...
    axes[0].set_title(f'[{flightType.title()}] 7-Day Rolling Average Price')
    ...
    axes[1].set_title(f'[{flightType.title()}] Monthly Average Price')
    ...
    axes[2].set_title(f'[{flightType.title()}] Price Distribution by Season')
    ...
    ax1.set_title(f'Observed')
    decomposition.trend.plot(ax=ax2)
    ax2.set_title(f'Trend')
    decomposition.seasonal.plot(ax=ax3)
    ax3.set_title(f'Seasonal')
    ...
    plt.title(f'[{flightType.title()}] Seasonal Price Distribution for Top 10 Destinations')
    plt.xlabel('Price ($)')
    ...
    plt.title(f'[{flightType.title()}] Average Prices by Agency and Season')
    plt.xlabel('Agency')
